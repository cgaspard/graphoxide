...
pub struct GraphCommunityTopic {
    pub id: String,
    pub label: String,
...
pub struct GraphCommunityTopicTree {
    pub topics: Vec<GraphCommunityTopic>,
...
pub fn derive_graph_community_topic_tree(
    graph: &KnowledgeGraph,
) -> anyhow::Result<GraphCommunityTopicTree> {
    let communities = communities(graph);
    if communities.is_empty() {
        return Ok(GraphCommunityTopicTree::default());
    }
...
/// used by both topic placement and graph-community Markdown navigation.
